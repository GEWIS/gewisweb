...
final class Version20260715230000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE HiddenPhoto (id INT AUTO_INCREMENT NOT NULL, member_id INT NOT NULL, photo_id INT NOT NULL, INDEX IDX_87F4497C7E9E4C8C (photo_id), UNIQUE INDEX hidden_photo_uniq (member_id, photo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
