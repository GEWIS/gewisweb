...
phpcsfix:
		@vendor/bin/php-cs-fixer fix --cache-file=data/cache/.php-cs-fixer.cache --rules=@PSR1,-@PSR12,-@Symfony,-@DoctrineAnnotation module
		@vendor/bin/php-cs-fixer fix --cache-file=data/cache/.php-cs-fixer.cache --rules=@PSR1,-@PSR12,-@Symfony,-@DoctrineAnnotation config

phpcsfixtypes:
		@vendor/bin/php-cs-fixer fix --cache-file=data/cache/.php-cs-fixer.cache --allow-risky=yes --rules=@PSR1,-@PSR12,-@Symfony,-@DoctrineAnnotation,-phpdoc_to_param_type,-phpdoc_to_property_type,-phpdoc_to_return_type /code/module
		@vendor/bin/php-cs-fixer fix --cache-file=data/cache/.php-cs-fixer.cache --allow-risky=yes --rules=@PSR1,-@PSR12,-@Symfony,-@DoctrineAnnotation,-phpdoc_to_param_type,-phpdoc_to_property_type,-phpdoc_to_return_type /code/config
