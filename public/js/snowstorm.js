...
var snowStorm = (function(window, document) {
    ...
    this.snowColor = '#d7dadb';     // Don't eat (or use?) yellow snow.
    this.snowCharacter = '&bull;';  // &bull; = bullet, &middot; is square on some systems etc.
    this.snowStick = true;          // Whether or not snow should "stick" at the bottom. When off, will never collect.
    this.targetElement = 'gewis-festivities'; // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
    ...
    this.zIndex = 1000000;          // CSS stacking order applied to each snowflake
