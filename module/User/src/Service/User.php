...
class User
{
            ...
            $this->getActivateForm($userType)->setMessages([
                'password' => [
                    $this->translator->translate(
                        ...
                        'You cannot use this password, it was found in a public data breach and is therefore considered insecure. We recommend using a password generated by a good password manager, such as Bitwarden or 1Password.',
                    ),
                ],
            ]);
    ...
    public function userLogin(array $data): ?UserModel
    {
        ...
        $this->userAuthService->setRememberMe('1' === $data['remember']);
