    ...
    public function loginAction(): Response|ViewModel
    {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                if (null !== $login) {
                    if ($login->getMustChangePassword()) {
                        $this->flashMessenger()->addErrorMessage(
                            // phpcs:ignore -- user-visible strings should not be split
                            $this->translator->translate('Your current password was found in a public data breach and is therefore considered insecure. Please change it before continuing. We recommend using a password generated by a good password manager, such as Bitwarden or 1Password.')
                        );

                        return $this->redirect()->toRoute('user/password/change', ['user_type' => $userType]);
                    }
