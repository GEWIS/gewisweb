...
class AlbumController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $albumPage = $this->AlbumPlugin()->getAlbumPage($albumId, $activePage, 'album');
    ...
    /**
     * Shows a page with photo's of a member, or a 404 if this page does not exist
     * @return array|ViewModel
     */
    public function memberAction()
    {
        ...
        $activePage = (int)$this->params()->fromRoute('page');
        $albumPage = $this->AlbumPlugin()->getAlbumPage($lidnr, $activePage, 'member');
        if (is_null($albumPage)) {
            return $this->notFoundAction();
        }
