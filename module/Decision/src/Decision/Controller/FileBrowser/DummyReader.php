...
class DummyReader implements FileReader
{
    ...
    {
        $options = [
            '' => [ new FileNode('dir', 'myFolder/', 'myFolder'),
                new FileNode('file', 'rootlevelfilez', 'rootlevelfilez')],
            'myFolder/' => [new FileNode('dir', 'myFolder/NestedFolder/', 'NestedFolder'),
                new FileNode('file', 'myFolder/A-file', 'A-file'),
                new FileNode('file', 'myFolder/Another-file', 'Another-file')],
